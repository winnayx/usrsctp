...
unsafe extern "C" fn receive_cb(mut s: *mut socket, mut addr: sctp_sockstore,
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char)
 -> libc::c_int {
    ...
    if usrsctp_listen(s, 1 as libc::c_int) < 0 as libc::c_int {
        perror(b"usrsctp_listen\x00" as *const u8 as *const libc::c_char);
    }
    loop  {
        if usrsctp_accept(s, 0 as *mut sockaddr,
                          0 as *mut socklen_t).is_null() {
