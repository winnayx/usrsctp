...
unsafe extern "C" fn handle_upcall(mut sock: *mut socket,
    ...
    loop  {
        ...
        let mut len: socklen_t =
            ::std::mem::size_of::<sctp_sockstore>() as libc::c_ulong as
                socklen_t;
        ...
        if n < 0 as libc::c_int as libc::c_long {
            ...
            if flags & 0x2000 as libc::c_int != 0 {
                ...
                printf(b"Message of length %d received via %p:%u on stream %u with SSN %u and TSN %u, PPID %u, context %u, flags %x.\n\x00"
                       ...
                       n as libc::c_int, addr.sconn.sconn_addr,
                       ...
                       rn.recvv_rcvinfo.rcv_context, flags);
            }
        } else {
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char)
 -> libc::c_int {
    ...
    printf(b"to %d.\n\x00" as *const u8 as *const libc::c_char, cur_buf_size);
    on = 1 as libc::c_int;
    if usrsctp_setsockopt(s_l, IPPROTO_SCTP as libc::c_int,
                          0x1f as libc::c_int,
